...
- Risk rationale:
- Final head SHA:
- Codex — first, on the green draft, and not optional: reviewed, nothing blocking outstanding (quote it) | reviewed, findings answered below | not reviewed (say why). Unmetered, so uncapped
