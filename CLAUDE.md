...
directions at once: two files to edit for every contract change, and a block of test written to
police the gap between them. ADR-0064 ends it. `.claude/skills/tether-worker/SKILL.md`
