...
- <a id="verma2024"></a>**[Verma 2024]** Verma AR, Ray KK, Bodick M, Kinz-Thompson CD, Gonzalez RL Jr. [*Increasing the accuracy of single-molecule data analysis using tMAVEN.*](https://doi.org/10.1016/j.bpj.2024.01.022) *Biophysical Journal* 123(14):2179–2193 (2024). tMAVEN — the embedded idealization sidecar whose plot definitions this gallery is asserted against.
