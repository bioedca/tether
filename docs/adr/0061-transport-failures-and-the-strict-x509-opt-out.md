...
[#336](https://github.com/bioedca/tether/issues/336) later added a sixth — an issue whose body
declares an autonomy no agent may claim — so the count above is five *as of this record*. The
