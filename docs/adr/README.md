...
| [0061](0061-transport-failures-and-the-strict-x509-opt-out.md) | A transport failure is not a scope verdict, and strict X.509 conformance is opt-out | accepted. The exit-code half implements [#315](https://github.com/bioedca/tether/issues/315) | §12.2–§12.5 (agent tooling). No runtime module changes; `claim.py` is CI/agent |
